...
export async function updateSession(request: NextRequest) {
  ...
  // Gate protected segments at the edge so unauthenticated users get bounced to
  // /login instead of hitting the server component and discovering the auth
  // failure further down the request lifecycle.
  //
  // NOTE: the product marketing pages (/products/ezstemz, /products/kitforge)
  // stay open. Only "/my-products" — the owned-products view — is gated.
